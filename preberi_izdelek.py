...
# odpremo html, ki smo ga prej nalozili (v preberi_celoten_page) in poiscemo linke do izdelkov
# spletna stran je zgrajena tako da so vse informacije o izdelku sele ko odpres izdelek sam
with open('shranjene_datoteke/html.txt') as d:
...
orodja.zapisi_json(vsi_izdelki, 'shranjene_datoteke/izdelki.json')
